...
The recording image retains a solid white body and red eyes, with a thin dark
edge for visibility on light backgrounds. Its colors are independent of the app
theme, which can differ from the menu bar appearance. The red eyes appear only in confirmed `recording` state,
